...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) [![npm version](https://img.shields.io/npm/v/@isilin/react-slot?color=blue)](https://www.npmjs.com/package/@isilin/react-slot)
...
[![Build Status](https://github.com/Isilin/react-slot/actions/workflows/deploy-storybook.yml/badge.svg)](https://github.com/Isilin/react-slot/actions/workflows/deploy-storybook.yml) [![codecov](https://codecov.io/gh/Isilin/react-slot/branch/main/graph/badge.svg?token=T5H2I3IPSI)](https://codecov.io/gh/Isilin/react-slot)
